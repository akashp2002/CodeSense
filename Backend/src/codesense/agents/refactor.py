            ...
            async with ClientSession(read, write) as session:
                ...
                if phase == "refactor":
                    system_prompt = (
                        ...
                        "replace text, and get git diffs.\n\n"
                        "INSTRUCTIONS — follow these steps IN ORDER, then STOP:\n"
                        "1. Use `search_file` to find ALL occurrences of the code to change.\n"
                        "2. Use `replace_in_file` to replace the old text with the new text. "
                        "This tool replaces ALL occurrences in the file. Call it once per file.\n"
                        "3. Use `get_git_diff` to verify your changes.\n"
                        "4. Return the diff as your final answer. DO NOT call any more tools.\n\n"
                        "CRITICAL RULES:\n"
                        "- Do NOT use `read_file` or `replace_lines`. Use `replace_in_file` instead.\n"
